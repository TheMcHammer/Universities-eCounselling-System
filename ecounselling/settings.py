"""
Django settings for ecounselling project.
...
SECRET_KEY = 'q#yrne5alh4syk_=jfcq8lfmc!f=ji@!@%)k0niho&)g_7%@g%'
...
ROOT_URLCONF = 'ecounselling.urls'
...
WSGI_APPLICATION = 'ecounselling.wsgi.application'
